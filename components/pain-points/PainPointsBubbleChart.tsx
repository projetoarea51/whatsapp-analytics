...
import type { PainPointsBubbleChartProps } from "@/types"
...
export function PainPointsBubbleChart({
  ...
  useEffect(() => {
    if (!svgRef.current || dimensions.width === 0 || !painPoints || painPoints.length === 0) return
    ...
    const bubbles = svg
      ...
      .on("click", (event, d: any) => {
        ...
        if (onBubbleClick) onBubbleClick(d.category)
      })
